CONFIGURACION PARA MOODLE
==================

-Cambie la ruta dataroot del archivo D:\casdschool\server\moodle\config.php en donde este guardada la carpeta casdschool.
-Ejecute Start Moodle.exe y de la opcion 1.
-Acceda a través de un navegador por medio de localhost a la plataforma.

Usuario administrador
user: admin pass: A12345678!
