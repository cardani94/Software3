...
class __Mustache_54b1e40e8d2120f2b36c536a8af1a17b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section3a07c329d33d6158e3f558f7107c47dc($context, $indent, $value);
...
';
    ...
    private function section3a07c329d33d6158e3f558f7107c47dc(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
...
';
                $buffer .= $indent . 'require([\'jquery\',\'theme_boost/tooltip\'], function($){$(\'[data-toggle="tooltip"]\').tooltip()});
';
