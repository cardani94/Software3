...
class __Mustache_da848e68bd20617bab15b832fa18148a extends Mustache_Template
{
...
';
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->sectionA0aa5257b44c0484fbc51082010a5258($context, $indent, $value);
        }
...
';
    ...
    private function sectionA0aa5257b44c0484fbc51082010a5258(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
