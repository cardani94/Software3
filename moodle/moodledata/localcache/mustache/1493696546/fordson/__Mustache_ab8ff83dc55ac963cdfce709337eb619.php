...
class __Mustache_ab8ff83dc55ac963cdfce709337eb619 extends Mustache_Template
{
...
';
        ...
        // 'disabled' section
        $value = $context->find('disabled');
        $buffer .= $this->sectionCf17b05692540eb3ed34572ab0d35b27($context, $indent, $value);
    ...
    private function sectionCf17b05692540eb3ed34572ab0d35b27(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
